...
export default async function handler(request, response) {
  ...
  const researchPlan = request.body?.tool === 'research'
...
${admissionsAudit
  ...
  : statementPlan
    ...
    : researchPlan
      ? '{"summary":"","researchQuestion":"","scope":[""],"method":[""],"sourcePlan":[""],"milestones":[""],"nextAction":""}'
...
${admissionsAudit
  ...
  : statementPlan
    ...
    : researchPlan
      ? 'Include one focused, feasible researchQuestion. Give 2 or 3 concise items each for scope, method, sourcePlan and milestones. Suggest source types and search terms, never fabricated citations. Make nextAction one concrete first task.'
